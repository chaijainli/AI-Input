...
class SettingsActivity : Activity() {
    ...
    private lateinit var skillList: ListView
    ...
    private fun showSkillList(category: String) {
        ...
        val skills: List<com.aikb.ime.ai.AISkill> = if (category == "love") {
            LoveSkills.all() as List<com.aikb.ime.ai.AISkill>
        } else {
            BusinessSkills.all() as List<com.aikb.ime.ai.AISkill>
        }
